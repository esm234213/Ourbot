...
TEAMS = {
    ...
    "team_other": "تيم الإمكانيات الأخرى"
}
...
# Special questions for "Other Capabilities" team
OTHER_CAPABILITIES_QUESTIONS = {
    "reason": """
شكراً! 🙏

بما أنك اخترت تيم الإمكانيات الأخرى، نريد نعرف:
- إيه المهارات أو الإمكانيات الخاصة عندك؟
- إيه المجالات اللي تحب تشتغل فيها؟
- ليه شايف إن مهاراتك دي هتفيد الفريق؟
""",
    "experience": """
شكراً لإجابتك! 🙏

السؤال التالي: عندك أي مشاريع أو أعمال سابقة استخدمت فيها هذه المهارات؟

لو عندك أعمال سابقة، وصفها لنا بالتفصيل.
ولو مش عندك، اشرح كيف ممكن تطبق مهاراتك في الفريق.
"""
}
